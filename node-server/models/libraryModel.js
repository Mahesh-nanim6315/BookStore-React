...
async function getLibraryRowsByUserId(userId) {
  return knex("user_library as ul")
    .select(
      "ul.id",
      "ul.user_id",
      "ul.book_id",
